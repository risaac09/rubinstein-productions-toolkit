...
```mermaid
graph TD
    subgraph T1["Type 1, Institutional"]
        A1[Royal register]
        A2[Counts, rates, deliverables]
        A3["Level A: signal"]
        A4[Observer-independent]
    end
    subgraph T2["Type 2, Relational"]
        B1[Nomadic register]
        B2[Narrative, texture, emergence]
        B3["Level B: semantic"]
        B4[Observer-dependent]
    end
    subgraph T3["Type 3, Reflexive"]
        C1[Practitioner register]
        C2[Question quality, projection, somatic resonance]
        C3["Level C: effectiveness"]
        C4[Observer-constitutive]
    end
    T1 -.->|"juxtaposition, not reduction"| T2
    T2 -.->|"participatory turn"| T3
    T3 -.->|"institutional accountability"| T1
    T3 ==>|"warrants"| T2
    T2 ==>|"contextualizes"| T1

    classDef t1 fill:#c8923a,stroke:#1a1412,color:#1a1412
    classDef t2 fill:#8b2e1c,stroke:#1a1412,color:#faf8f5
    classDef t3 fill:#1a1412,stroke:#c8923a,color:#faf8f5
    class T1,A1,A2,A3,A4 t1
    class T2,B1,B2,B3,B4 t2
    class T3,C1,C2,C3,C4 t3
```
