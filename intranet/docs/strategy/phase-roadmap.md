...
## Phase 1: Foundation (2025–2026) — ACTIVE

Build the practice infrastructure and land the first clients.
...
- Content strategy defined (craft-first positioning)
- CLI pipeline tools built (outreach, grants, prospect management)
...
Scale through group offerings and strategic partnerships while protecting solo delivery capacity.
...
| Milestone | Target |
|-----------|--------|
| First paid workshop delivered | Q1 2027 |
| 3 conference speaking engagements | Q2 2027 |
| First strategic partnership (health system or foundation) | Q3 2027 |
| Operations support hired (part-time) | Q4 2027 |
| Revenue: $100K annual | End of Phase 2 |

---

## Phase 3: Scale (2027+)

Build beyond solo practice into ecosystem and intellectual property.
...
!!! warning "Phase Discipline"
    The biggest risk is premature scaling — building courses or platforms before the 1:1 methodology is battle-tested. Phase 1 is about doing the work. Phase 2 is about teaching it. Phase 3 is about packaging it. Do not skip steps.
