...
**Primary Anchor:** Pain (founders in transition experience acute, searchable problems around communication, identity, and coherence during org change)

**Persona:** Founder whose organization is in active transition — growing (scaling past founder-dependence), restructuring (reorgs, layoffs, role changes), or rebranding (identity shifts, repositioning, mission evolution).

**Life Context:** The founder is the symbolic voice of the org. During transition, the gap between what they're saying publicly, what they're saying internally, and what they actually believe starts to crack open. Team members sense the incoherence. Investors sense the incoherence. Customers sense the incoherence. The founder often senses it last — or senses it but can't name it.

**Core Pain:** The founder's voice no longer matches the org's moment. The old narrative doesn't fit the new reality, but the new narrative hasn't arrived yet. They're speaking in placeholders — and everyone can tell.

**Messaging Angle (core truth):** "Your company changed. Your voice didn't."

This is the anchor angle. Below, it gets expressed differently at each awareness stage — same truth, adapted to where the founder is in their journey.

---

## Stage 1: Unaware

**Founder state:** Doesn't know the voice-org mismatch is a nameable problem. They feel the friction (pitch decks landing flat, all-hands that don't land, launches that don't move people) but attribute it to market conditions, team execution, or their own tiredness.

**Goal:** Make the problem visible. Help them notice the pattern.

**Angle expression:** "The thing your team isn't saying out loud"

**Sample framing:** "Your team has stopped forwarding your all-hands recaps. Not because the updates are bad — because something in how you're saying them doesn't match what they're seeing. When an org changes faster than its founder's voice, people feel it before they can name it. Here's the pattern."

**Why this works at Unaware:** Names a specific, observable symptom (team stops forwarding recaps) and attributes it to an invisible cause (voice-org mismatch during transition). Creates pattern recognition without asking them to commit to a diagnosis.

---

## Stage 2: Problem-Aware

**Founder state:** Knows something is off with how they're showing up. Has said things like "I don't sound like myself anymore" or "my old pitch doesn't work but I don't know what the new one is." Doesn't yet know this is a category of problem anyone addresses.

**Goal:** Agitate and validate. Name the specific experience.

**Angle expression:** "You're pitching a company that doesn't exist anymore"

**Sample framing:** "You rewrote the deck. You tightened the about page. You practiced the new story in front of the mirror. And it still comes out sounding like the version of the company from two funding rounds ago. That's not a writing problem. That's a voice lag. Your identity is catching up to your reality — and until it does, every message you send lands half a beat off."

**Why this works at Problem-Aware:** Mirrors the founder's actual inner monologue, validates that the symptoms they're experiencing are real, and gives the problem a name ("voice lag") that makes it feel addressable.
...
**Founder state:** Ready to engage. Needs the final push — clarity on format, commitment, timeline, fit.

**Goal:** Close. Direct invitation with specificity.
...
| Stage | Angle Expression | Strategic Job |
|---|---|---|
...
All five expressions carry the same core truth — **your company changed, your voice didn't** — adapted to where the founder is in the journey from "doesn't know this is a problem" to "ready to book."
